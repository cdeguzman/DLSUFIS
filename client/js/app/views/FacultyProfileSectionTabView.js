...
>>>>>>> 1caa0c8503922b9b3836b99a256934322bfa3de8
        inResFundedModel.set('inputData', new Array(
		  ...
		  {inputLabel: "Year Start", inputName: "start_year", inputType: "year"},
		  {inputLabel: "Year End", inputName: "end_year", inputType: "year"}
		));
	 ...
	 var exResFundedModel = facultyProfileSectionModel.clone();
        ...
        exResFundedModel.set('keys', new Array('research_title','fagency', 'currency', 'amount','year_start', 'year_end'));
        exResFundedModel.set('collumnNames', new Array('Research Projects/Activites', 'Funding Agency', 'Currency','Amount of Research Grant', 'Year Start', 'Year End'));
        exResFundedModel.set('inputData', new Array(
			...
			{inputLabel: "Amount of Research Grant", inputName: "amount", inputType: "text"},
			{inputLabel: "Start Year", inputName: "start_year", inputType: "year"},
			{inputLabel: "End Year", inputName: "end_year", inputType: "year"}
		));
     ...
     var resGrantsModel = facultyProfileSectionModel.clone();
        ...
        resGrantsModel.set('keys', new Array('research_title','fagency', 'year_start', 'year_end'));
        resGrantsModel.set('collumnNames', new Array('Research Projects/Activites', 'Funding Agency', 'Year Start', 'Year End'));
	...
	this.subViews.push(new FacultyProfileSectionView({
     ...
     var comServeDLSUModel = facultyProfileSectionModel.clone();
        ...
        comServeDLSUModel.set('collumnNames', new Array('Description of Involvement/Service/Work Done', 'Committee', 'Start Date','End Date'));
