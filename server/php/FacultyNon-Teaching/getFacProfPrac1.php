<?php
  include("../connect.php");
    if($_GET["fid"]!= NULL){ 
       ...
       $select_profprac1 = mysql_query("SELECT pp.pp_id AS id, pp.work_nature, i.institution_name, pp.no_years, pp.start_date, pp.end_date
                                        FROM professional_prac pp, institution i   
									    WHERE pp.fid = $fid AND pp.institution_id = i.institution_id
									UNION
									    SELECT pp.pp_id AS id, pp.work_nature, o.org_name, pp.no_years, pp.start_date, pp.end_date
