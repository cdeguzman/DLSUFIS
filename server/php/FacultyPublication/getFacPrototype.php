<?php
  include("../connect.php");
    if($_GET["fid"]!= NULL){ 
      ...
      $select_prototype = mysql_query("SELECT p.pub_code AS id, f.flname, p.paper_title, j.journal_title, p.date_publication, p.volume_no, p.issue_no, p.pages, p.publication_type 
