<?php
  include("../connect.php");
    if($_GET["fid"]!= NULL){ 
      ...
      $select_degree = mysql_query("SELECT de.de_id as id, dl.dlevel_title, d.degree_title, de.specialization, de.year_obtained, i.institution_name, i.location, de.so_num  
