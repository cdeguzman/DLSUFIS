  ...
  render: function(){
    ...
    html+='<div class="loadingStatus"><i class="fa fa-spinner fa-spin"></i> Loading...</div>';
     ...
     var degreePursueModel = facultyProfileSectionModel.clone();
	   ...
	   //degreePursueModel.set('editUrl', App.degreeEarnedEditUrl);
     ...
     var specialTrainingModel = facultyProfileSectionModel.clone();
	    ...
	    //specialTrainingModel.set('editUrl', App.degreeEarnedEditUrl);
	...
	var teachExpModel = facultyProfileSectionModel.clone();
	    ...
	    //teachExpModel.set('editUrl', App.degreeEarnedEditUrl);
	...
	var licenseModel = facultyProfileSectionModel.clone();
	    ...
	    //licenseModel.set('editUrl', App.degreeEarnedEditUrl);
	...
	var nonTeachExpModel = facultyProfileSectionModel.clone();
		...
		//nonTeachModel.set('editUrl', App.degreeEarnedEditUrl);
	    ...
	    //leadershipInOrgModel.set('editUrl', App.degreeEarnedEditUrl);
	 ...
	 var membershipInOrgProfModel = facultyProfileSectionModel.clone();
		...
		//membershipInOrgProf.set('editUrl', App.degreeEarnedEditUrl);
	 ...
	 var awardsModel = facultyProfileSectionModel.clone();
		...
		//awardsModel.set('editUrl', App.degreeEarnedEditUrl);
		awardsModel.getData();
	 ...
	 var inResFundedModel = facultyProfileSectionModel.clone();
		...
		//inResFundedModel.set('editUrl', App.degreeEarnedEditUrl);
	 ...
	 var exResFundedModel = facultyProfileSectionModel.clone();
		...
		//exResFundedModel.set('editUrl', App.degreeEarnedEditUrl);
     ...
     var resGrantsModel = facultyProfileSectionModel.clone();
		...
		//resGrantsModel.set('editUrl', App.degreeEarnedEditUrl);
     ...
     var journalPubModel = facultyProfileSectionModel.clone();
		...
		//journalPubModel.set('editUrl', App.degreeEarnedEditUrl);
	...
	this.subViews.push(new FacultyProfileSectionView({
     ...
     var pubPrototypeModel = facultyProfileSectionModel.clone();
		...
		//pubPrototypeModel.set('editUrl', App.degreeEarnedEditUrl);
     ...
     var patentModel = facultyProfileSectionModel.clone();
		...
		//patentModel.set('editUrl', App.degreeEarnedEditUrl);
		patentModel.getData();
     ...
     var textbookModel = facultyProfileSectionModel.clone();
		...
		//textbookModel.set('editUrl', App.degreeEarnedEditUrl);
     ...
     var chapTextbookModel = facultyProfileSectionModel.clone();
		...
		//chapTextbookModel.set('editUrl', App.degreeEarnedEditUrl);
     ...
     var confPaperModel = facultyProfileSectionModel.clone();
		...
		//confPaperModel.set('editUrl', App.degreeEarnedEditUrl);
     ...
     //Published Creative Works
      var creativeWorksModel = facultyProfileSectionModel.clone();
		...
		//creativeWorksModel.set('editUrl', App.degreeEarnedEditUrl);
     ...
     //Screen Play
      var screenPlayWorksModel = facultyProfileSectionModel.clone();
		...
		//screenPlayWorkModel.set('editUrl', App.degreeEarnedEditUrl);
     ...
     //Other Research
      var otherResearchModel = facultyProfileSectionModel.clone();
		...
		//otherResearchModel.set('editUrl', App.degreeEarnedEditUrl);
      ...
      //Conferences
		...
		//conferenceModel.set('editUrl', App.degreeEarnedEditUrl);
     ...
     var comServeDLSUModel = facultyProfileSectionModel.clone();
		...
		//comServeDLSUModel.set('editUrl', App.degreeEarnedEditUrl);
     ...
     var profOrgModel = facultyProfileSectionModel.clone();
		...
		//profOrgModel.set('editUrl', App.degreeEarnedEditUrl);
	 ...
	 var govOrgModel = facultyProfileSectionModel.clone();
		...
		//govOrgModel.set('editUrl', App.degreeEarnedEditUrl);
		govOrgModel.getData();
     ...
     var otherOrgModel = facultyProfileSectionModel.clone();
		...
		//otherOrgModel.set('editUrl', App.degreeEarnedEditUrl);
	...
	// Faculty Profile
        ...
        facProfileModel.set('sectionId', 'changePassword');
		...
		//facProfileModel.set('editUrl', App.degreeEarnedEditUrl);
